...
- ✅ 總月銷量: 9669 (正確)
- ✅ Dashboard 跟隨進階搜尋過濾
- ✅ Dashboard 不跟隨 filterMode（僅顯示需補貨型號）
...
**測試組合**:
- ✅ 只開 filterMode: Dashboard 保持全店總計
- ✅ filterMode + 進階搜尋: Dashboard 只跟隨進階搜尋
- ✅ 清除進階搜尋保持 filterMode: Dashboard 恢復全店總計
